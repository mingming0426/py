...
print("-- -- -- 卡牌对决 -- -- --")
card1 = {"名称": "诺兹多姆", "攻击力": 5000, "防御力": 4000, "敏捷": 40, "攻击距离": 4}
card2 = {"名称": "阿莱克斯塔萨", "攻击力": 3000, "防御力": 2000, "敏捷": 60, "攻击距离": 2}
card3 = {"名称": "伊瑟拉", "攻击力": 2000, "防御力": 6000, "敏捷": 30, "攻击距离": 1}
card4 = {"名称": "玛里苟斯", "攻击力": 2000, "防御力": 4000, "敏捷": 50, "攻击距离": 1}
card5 = {"名称": "耐萨里奥", "攻击力": 6000, "防御力": 2000, "敏捷": 20, "攻击距离": 3}
card6 = {"名称": "火箭炮", "攻击力": 9000, "防御力": 8000, "敏捷": 49.99999, "攻击距离": 5}
card7 = {"名称": "核弹", "攻击力": 9999, "防御力": 10000, "敏捷": 70, "攻击距离": 6}
card8 = {"名称": "原子弹", "攻击力": 9999, "防御力": 10000, "敏捷": 70, "攻击距离": 7}
print("""规则：
1、双方初始血量：10000
2、对决之前，双方随机获得3张卡牌
...
if spring <= 30:
    ...
    if magic <= 50:
        print("攻击力小于3000卡牌的受到 泰坦祝福！")
        for i in cards:
            if i["攻击力"] < 3000:
                i["buff"] = "泰坦祝福！"

    else:
        print("攻击力高于8000卡牌的受到 混沌诅咒！")
        for i in cards:
            if i["攻击力"] > 8000:
                i["buff"] = "混沌诅咒！"
else:
