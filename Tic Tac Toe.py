...
B1 = Button(tk, text=" ", font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B1))
B1.grid(row=3, column=0)

B2 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B2))
B2.grid(row=3, column=1)

B3 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B3))
B3.grid(row=3, column=2)

B4 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B4))
B4.grid(row=4, column=0)

B5 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B5))
B5.grid(row=4, column=1)

B6 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B6))
B6.grid(row=4, column=2)

B7 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B7))
B7.grid(row=5, column=0)

B8 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
            height=4, width=8, command=lambda: buttonClick(B8))
B8.grid(row=5, column=1)

B9 = Button(tk, text=' ', font='Times 20 bold', bg='green', fg='blue',
